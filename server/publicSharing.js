...
<head>
  ...
  <title>${esc(bucketName)} · jot.it</title>
  <style>
...
<body>
  <header>
    <span class="wordmark">jot.it</span>
    <span class="sep">/</span>
  ...
  <footer class="page-footer">built with jot.it</footer>
</body>
</html>`
}
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width,initial-scale=1">
  <title>Shared note · jot.it</title>
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0 }
    body {
      background: #09090b;
...
<body>
  <header class="topbar">
    <a href="/" class="topbar-brand">jot.it</a>
...
function renderNotFoundPage(kind, pathValue) {
  return `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Not found · jot.it</title>
